        ...
        <div class="card card-body bg light mt-5">
            ...
            <form action="<?php echo URLROOT; ?>/users/register" method="post">
                <div class="form-group">
                    <label for="name">Name: <sub>*</sup></label>
                ...
                <div class="form-group">
                    <label for="email">Email: <sub>*</sup></label>
                ...
                <div class="form-group">
                    <label for="password">Password: <sub>*</sup></label>
                ...
                <div class="form-group">
                    <label for="confirm_password">Confirm_password: <sub>*</sup></label>
